...
//   Runs the AC-403 fixture (post-type-badge--* and the other
...
if (isMain) {
  console.log('--- AC-403 fixture: Liquid-interpolated class stems must classify LIVE ---\n');
  ...
  for (const stem of STEMS) {
    if (stem.id === 'post-type-badge') continue;
    const resolved = stem.resolve();
